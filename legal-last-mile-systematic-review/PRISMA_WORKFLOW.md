...
**135 have been screened (67 include / 68 exclude)**, with the researcher
...
(full extraction) is likewise live: **65 studies (S001–S065) are fully
...
67 current full-text includes. Phase 9 (risk of bias) is intentionally
...
65 extracted studies, both the mechanically-derivable fields (via
