...
**161 have been screened (79 include / 82 exclude)**, with the researcher
...
(full extraction) is likewise live: **77 studies (S001–S077) are fully
extracted** into `extraction_database.csv` against `CODEBOOK.md`'s full
92-field schema, with 2 older flagged studies awaiting full-text
re-upload (never fabricated from memory) separating this count from the
79 current full-text includes. Phase 9 (risk of bias) is intentionally
not yet applied to any of the 77 — `risk_of_bias_tool` is identified per
...
77 extracted studies, both the mechanically-derivable fields (via
