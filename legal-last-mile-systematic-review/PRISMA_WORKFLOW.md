...
**974 have been screened (488 include / 486 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 488
...
intentionally not yet applied to the great majority of the 488 (a first
...
against all 488 extracted studies, both the mechanically-derivable fields
(via
