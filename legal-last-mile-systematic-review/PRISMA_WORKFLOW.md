...
**829 have been screened (397 include / 432 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 397
current full-text includes (S001–S399, S227 a documented gap) are fully extracted** into
`extraction_database.csv` against `CODEBOOK.md`'s full 92-field schema.
Phase 9 (risk of bias) is
intentionally not yet applied to the great majority of the 397 (a first
...
against all 397 extracted studies, both the mechanically-derivable fields
(via
