...
| 8 | Full extraction | **Fully caught up with Phase 6 — no outstanding gap.** `03_extraction/extracted_data/extraction_database.csv` holds **122 fully-extracted studies (S001–S122)**, all 92 `CODEBOOK.md` fields populated per study, matching all **122** current full-text includes. Every new full-text include is extracted in the same session it clears Phase 6, rather than accumulating in a backlog. `reviewer_1` for S001-S085 is `Claude-AI-fulltext-2026-09-12`; for S086-S092 it is `Claude-AI-extraction-2026-09-13`; for S093-S122 it is `Claude-AI-extraction-2026-09-15`; `reviewer_2`/`final_decision` are blank pending a second extraction pass (see Phase 9 note on the same open reviewer_2 question). Five of the 122 (S015, S019, S027, S052, S116) are themselves secondary systematic reviews, and a sixth (S079) is a secondary focused review, all flagged `study_design_class = systematic_review_secondary`, never to be pooled as an independent primary effect. |
...
**252 have been screened (122 include / 130 exclude)**, with the researcher
...
current full-text includes (S001–S122) are fully extracted** into
