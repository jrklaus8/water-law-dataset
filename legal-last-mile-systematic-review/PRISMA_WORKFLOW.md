...
**151 have been screened (75 include / 76 exclude)**, with the researcher
...
(full extraction) is likewise live: **73 studies (S001–S073) are fully
...
75 current full-text includes. Phase 9 (risk of bias) is intentionally
...
73 extracted studies, both the mechanically-derivable fields (via
