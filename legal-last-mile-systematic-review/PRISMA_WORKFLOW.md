...
**145 have been screened (71 include / 74 exclude)**, with the researcher
...
(full extraction) is likewise live: **69 studies (S001–S069) are fully
...
71 current full-text includes. Phase 9 (risk of bias) is intentionally
...
69 extracted studies, both the mechanically-derivable fields (via
