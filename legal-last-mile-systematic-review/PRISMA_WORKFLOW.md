...
**811 have been screened (387 include / 424 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 387
current full-text includes (S001–S388, S227 a documented gap) are fully extracted** into
`extraction_database.csv` against `CODEBOOK.md`'s full 92-field schema.
Phase 9 (risk of bias) is
intentionally not yet applied to the great majority of the 387 (a first
...
against all 387 extracted studies, both the mechanically-derivable fields
(via
