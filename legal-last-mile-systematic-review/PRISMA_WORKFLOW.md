...
**1,006 have been screened (505 include / 501 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 505
...
intentionally not yet applied to the great majority of the 505 (a first
...
against all 505 extracted studies, both the mechanically-derivable fields
(via
