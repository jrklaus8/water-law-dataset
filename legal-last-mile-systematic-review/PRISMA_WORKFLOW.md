...
**994 have been screened (500 include / 494 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 500
...
intentionally not yet applied to the great majority of the 500 (a first
...
against all 500 extracted studies, both the mechanically-derivable fields
(via
