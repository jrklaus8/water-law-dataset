...
**983 have been screened (492 include / 491 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 492
...
intentionally not yet applied to the great majority of the 492 (a first
...
against all 492 extracted studies, both the mechanically-derivable fields
(via
