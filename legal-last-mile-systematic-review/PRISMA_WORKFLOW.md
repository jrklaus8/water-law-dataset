...
**979 have been screened (489 include / 490 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 489
...
intentionally not yet applied to the great majority of the 489 (a first
...
against all 489 extracted studies, both the mechanically-derivable fields
(via
