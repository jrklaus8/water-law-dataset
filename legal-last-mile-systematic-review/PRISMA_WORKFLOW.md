...
**997 have been screened (501 include / 496 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 501
...
intentionally not yet applied to the great majority of the 501 (a first
...
against all 501 extracted studies, both the mechanically-derivable fields
(via
