...
**1,009 have been screened (506 include / 503 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 506
...
intentionally not yet applied to the great majority of the 506 (a first
...
against all 506 extracted studies, both the mechanically-derivable fields
(via
