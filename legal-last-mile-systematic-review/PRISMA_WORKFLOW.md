...
**989 have been screened (496 include / 493 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 496
...
intentionally not yet applied to the great majority of the 496 (a first
...
against all 496 extracted studies, both the mechanically-derivable fields
(via
