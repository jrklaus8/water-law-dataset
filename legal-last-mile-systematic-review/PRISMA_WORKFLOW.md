...
(full extraction) is likewise live: **83 studies (S001–S083) are fully
...
85 current full-text includes. Phase 9 (risk of bias) is intentionally
not yet applied to any of the 83 — `risk_of_bias_tool` is identified per
...
83 extracted studies, both the mechanically-derivable fields (via
