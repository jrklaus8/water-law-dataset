...
**169 have been screened (82 include / 87 exclude)**, with the researcher
...
(full extraction) is likewise live: **80 studies (S001–S080) are fully
...
82 current full-text includes. Phase 9 (risk of bias) is intentionally
not yet applied to any of the 80 — `risk_of_bias_tool` is identified per
...
80 extracted studies, both the mechanically-derivable fields (via
