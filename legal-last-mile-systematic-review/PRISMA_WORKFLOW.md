...
**1,011 have been screened (508 include / 503 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 508
...
intentionally not yet applied to the great majority of the 508 (a first
...
against all 508 extracted studies, both the mechanically-derivable fields
(via
