...
**131 have been screened (64 include / 67 exclude)**, with the researcher
...
(full extraction) is likewise live: **62 studies (S001–S062) are fully
...
64 current full-text includes. Phase 9 (risk of bias) is intentionally
...
62 extracted studies, both the mechanically-derivable fields (via
