...
**1,001 have been screened (503 include / 498 exclude)**, with the researcher
...
(full extraction) is likewise live and now fully caught up: **all 503
...
intentionally not yet applied to the great majority of the 503 (a first
...
against all 503 extracted studies, both the mechanically-derivable fields
(via
