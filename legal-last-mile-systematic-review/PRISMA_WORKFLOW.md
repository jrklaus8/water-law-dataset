...
(full extraction) is likewise live: **60 studies (S001–S060) are fully
...
62 current full-text includes. Phase 9 (risk of bias) is intentionally
not yet applied to any of the 60 — `risk_of_bias_tool` is identified per
...
60 extracted studies, both the mechanically-derivable fields (via
