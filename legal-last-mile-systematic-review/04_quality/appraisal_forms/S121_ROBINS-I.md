# ROBINS-I Appraisal (partial/pilot) -- S121

**Citation:** Feler L, Henderson JV (2008). Exclusionary Policies in Urban Development: How Under-Servicing of Migrant Households Affects the Growth and Composition of Brazilian Cities. NBER Working Paper No. 14136.
...
|---|---|---|
| 1. Bias due to confounding | Moderate | Model-based strategic-interaction econometric estimates with real covariate control (locality wealth/size, housing size, migrant composition, education level) and mechanism_certainty=3 (quasi-experimental, per this project's own extraction), but the precise identification strategy ruling out remaining confounding is not detailed in the extracted text. Also an unpublished NBER working paper (peer_reviewed=FALSE), a separate disclosed limitation. |
