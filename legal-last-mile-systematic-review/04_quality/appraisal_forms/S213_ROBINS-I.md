# ROBINS-I Appraisal (partial/pilot) -- S213

**Citation:** Zziwa Nimanya C (2021). Improving governance in the water sector through social accountability, communication and transparency. International Journal of Biological and Chemical Sciences 15(7):35-52.
...
|---|---|---|
| 1. Bias due to confounding | Serious | Unadjusted before/after community-scorecard evaluation with no formal comparator group or confounder adjustment (extraction_database.csv gives no adjusted_or_unadjusted value and no covariates; core-urban households are mentioned as an informal point of contrast but not used as an adjusted comparator). |
...
## Overall judgement: at least Serious (partial; lower bound only)
