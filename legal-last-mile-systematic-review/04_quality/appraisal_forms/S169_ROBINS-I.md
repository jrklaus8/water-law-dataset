# ROBINS-I Appraisal (partial/pilot) -- S169

**Citation:** Pulgarin-Franco J-A (2024). La actualizacion catastral y las capacidades institucionales locales: impuesto predial y servicios publicos domiciliarios. Bitacora Urbano Territorial 34(1):97-114.
...
|---|---|---|
| 1. Bias due to confounding | Serious | Descriptive statistical panel analysis (extraction_database.csv: adjusted_or_unadjusted='descriptive statistical panel analysis') with no confounder adjustment described for the 53-municipality, 10-year panel. |
