...
(updated 2026-09-15): of 3,659, 454 have been assessed (222 include / 232
...
via researcher chat upload — the remaining 3,205 are simply not yet
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 3,205 are all retrievable -- it means
    ...
    continues.]
  Reports assessed for eligibility (n = 454, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-15. Full-text screening is ongoing, not complete -- 3,205 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 232 total, PROVISIONAL):
    E01 wrong topic (n = 53)
    E02 wrong population (n = 31)
    E03 wrong exposure (n = 5)
    E04 wrong outcome (n = 36)
    E05 no empirical evidence (n = 34)
    E06 engineering only (n = 25)
    E07 wrong service (n = 13)
    E08 duplicate (n = 3)
    E09 insufficient information (n = 1)
    E10 inaccessible full text (n = 22)
    E11 wrong jurisdiction/context (n = 0)
    E12 wrong study design (n = 9)

Included
  Studies included in systematic review (n = 222, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-15; full-text screening is
    still ongoing across the remaining 3,205 unreached records.]
  Studies included in full extraction so far (n = 222)
    [03_extraction/extracted_data/extraction_database.csv, S001-S222.
