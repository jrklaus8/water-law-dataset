...
(updated 2026-09-16): of 3,659, 794 have been assessed (372 include / 422
...
2,865 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,865 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 794, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-16. Full-text screening is ongoing, not complete -- 2,865 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 422 total, PROVISIONAL):
    E01 wrong topic (n = 92)
    E02 wrong population (n = 32)
    E03 wrong exposure (n = 10)
    E04 wrong outcome (n = 40)
    E05 no empirical evidence (n = 41)
    E06 engineering only (n = 33)
    E07 wrong service (n = 15)
    E08 duplicate (n = 5)
...
Included
  Studies included in systematic review (n = 372, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-16; full-text screening is
    still ongoing across the remaining 2,865 unreached records.]
  Studies included in full extraction so far (n = 372)
    [03_extraction/extracted_data/extraction_database.csv, S001-S373 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 13, PROVISIONAL AND GROWING)
    ...
    Drive-folder batch. These are the studies with a genuine, non-fabricated
    exposure-vs-comparator contrast and a locatable effect estimate -- a
    much smaller, stricter subset than the 132 studies evidence_map.csv
