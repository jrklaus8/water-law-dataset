...
(updated 2026-09-13): of 3,659, 193 have been assessed (92 include / 101
...
via researcher chat upload — the remaining 3,466 are simply not yet
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 3,466 are all retrievable -- it means
    ...
    continues.]
  Reports assessed for eligibility (n = 193, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-13. Full-text screening is ongoing, not complete -- 3,466 of
...
Included
  Studies included in systematic review (n = 92, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-13; full-text screening is
    still ongoing across the remaining 3,466 unreached records.]
  Studies included in full extraction so far (n = 92)
    [03_extraction/extracted_data/extraction_database.csv, S001-S092.
