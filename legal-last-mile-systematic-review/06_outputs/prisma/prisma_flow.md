...
(updated 2026-09-18): of 3,659, 1,030 have been assessed (515 include / 515
...
2,629 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,030, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-18. Full-text screening is ongoing, not complete -- 2,629 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 515 total, PROVISIONAL):
    E01 wrong topic (n = 148)
...
Included
  Studies included in systematic review (n = 515, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,629 unreached records.]
  Studies included in full extraction so far (n = 515)
    [03_extraction/extracted_data/extraction_database.csv, S001-S517 (S227
