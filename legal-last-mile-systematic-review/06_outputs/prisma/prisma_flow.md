...
(updated 2026-09-16): of 3,659, 809 have been assessed (385 include / 424
...
2,850 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,850 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 809, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-16. Full-text screening is ongoing, not complete -- 2,850 of
...
Included
  Studies included in systematic review (n = 385, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-16; full-text screening is
    still ongoing across the remaining 2,850 unreached records.]
  Studies included in full extraction so far (n = 385)
    [03_extraction/extracted_data/extraction_database.csv, S001-S386 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 13, PROVISIONAL AND GROWING)
    ...
    much smaller, stricter subset than the 138 studies evidence_map.csv
