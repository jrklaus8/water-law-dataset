...
(updated 2026-09-17): of 3,659, 918 have been assessed (465 include / 453
...
2,741 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,741 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 918, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-17. Full-text screening is ongoing, not complete -- 2,741 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 453 total, PROVISIONAL):
    E01 wrong topic (n = 97)
    E02 wrong population (n = 32)
    E03 wrong exposure (n = 16)
    E04 wrong outcome (n = 46)
...
Included
  Studies included in systematic review (n = 465, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-17; full-text screening is
    still ongoing across the remaining 2,741 unreached records.]
  Studies included in full extraction so far (n = 465)
    [03_extraction/extracted_data/extraction_database.csv, S001-S467 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 20, PROVISIONAL AND GROWING)
    ...
    performance) from the 2026-09-17 Google Drive batch 3. These are the
    studies with a genuine, non-fabricated exposure-vs-comparator contrast
    and a locatable effect estimate -- a much smaller, stricter subset
    than the 177 studies evidence_map.csv flags
