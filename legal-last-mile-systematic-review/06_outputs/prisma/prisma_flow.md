...
(updated 2026-09-12): of 3,659, 169 have been assessed (82 include / 87
...
via researcher chat upload — the remaining 3,490 are simply not yet
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 3,490 are all retrievable -- it means
    ...
    continues.]
  Reports assessed for eligibility (n = 169, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-12. Full-text screening is ongoing, not complete -- 3,490 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 87 total, PROVISIONAL):
    E01 wrong topic (n = 16)
    E02 wrong population (n = 29)
    E03 wrong exposure (n = 1)
    E04 wrong outcome (n = 16)
    E05 no empirical evidence (n = 10)
    E06 engineering only (n = 8)
...
Included
  Studies included in systematic review (n = 82, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-12; full-text screening is
    still ongoing across the remaining 3,490 unreached records.]
  Studies included in full extraction so far (n = 80)
    [03_extraction/extracted_data/extraction_database.csv, S001-S080.
    Only 2 of the 82 full-text includes remain unextracted, flagged as
