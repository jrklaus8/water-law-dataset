...
(updated 2026-09-17): of 3,659, 869 have been assessed (420 include / 449
...
2,790 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,790 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 869, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-17. Full-text screening is ongoing, not complete -- 2,790 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 449 total, PROVISIONAL):
...
Included
  Studies included in systematic review (n = 420, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-17; full-text screening is
    still ongoing across the remaining 2,790 unreached records.]
  Studies included in full extraction so far (n = 420)
    [03_extraction/extracted_data/extraction_database.csv, S001-S422 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 16, PROVISIONAL AND GROWING)
    ...
    estimate -- a much smaller, stricter subset than the 156 studies
