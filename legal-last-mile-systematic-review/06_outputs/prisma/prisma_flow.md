...
(updated 2026-09-21): of 3,659, 1,091 have been assessed (538 include / 553
...
2,568 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,091, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-21. Full-text screening is ongoing, not complete -- 2,568 of
...
Included
  Studies included in systematic review (n = 538, PROVISIONAL AND GROWING)
    ...
    still ongoing across the remaining 2,568 unreached records.]
