...
(updated 2026-09-12): of 3,659, 175 have been assessed (85 include / 90
...
via researcher chat upload — the remaining 3,484 are simply not yet
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 3,484 are all retrievable -- it means
    ...
    continues.]
  Reports assessed for eligibility (n = 175, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-12. Full-text screening is ongoing, not complete -- 3,484 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 90 total, PROVISIONAL):
    E01 wrong topic (n = 19)
