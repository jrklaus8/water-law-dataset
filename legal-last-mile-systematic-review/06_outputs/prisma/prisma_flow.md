...
(updated 2026-09-21): of 3,659, 1,137 have been assessed (568 include / 569
...
2,522 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,137, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-21. Full-text screening is ongoing, not complete -- 2,522 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 569 total, PROVISIONAL):
    E01 wrong topic (n = 176)
    E02 wrong population (n = 33)
    E03 wrong exposure (n = 21)
    E04 wrong outcome (n = 54)
    E05 no empirical evidence (n = 61)
...
Included
  Studies included in systematic review (n = 568, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-21; full-text screening is
    still ongoing across the remaining 2,522 unreached records.]
  Studies included in full extraction so far (n = 568)
    [03_extraction/extracted_data/extraction_database.csv, S001-S570 (S227
