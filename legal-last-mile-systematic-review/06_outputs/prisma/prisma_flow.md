...
(updated 2026-09-18): of 3,659, 983 have been assessed (492 include / 491
...
2,676 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 983, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-18. Full-text screening is ongoing, not complete -- 2,676 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 491 total, PROVISIONAL):
...
Included
  Studies included in systematic review (n = 492, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,676 unreached records.]
  Studies included in full extraction so far (n = 492)
    [03_extraction/extracted_data/extraction_database.csv, S001-S494 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 25, PROVISIONAL AND GROWING)
    ...
    188 studies evidence_map.csv flags
