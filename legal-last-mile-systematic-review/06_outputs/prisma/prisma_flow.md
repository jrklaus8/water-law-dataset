...
(updated 2026-09-23): of 3,659, 1,332 have been assessed (678 include / 654
...
2,327 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,327 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 1,332, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-23. Full-text screening is ongoing, not complete -- 2,327 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 654 total, PROVISIONAL):
    E01 wrong topic (n = 231)
    E02 wrong population (n = 33)
    E03 wrong exposure (n = 22)
    E04 wrong outcome (n = 59)
    E05 no empirical evidence (n = 76)
...
Included
  Studies included in systematic review (n = 678, PROVISIONAL AND GROWING)
    ...
    still ongoing across the remaining 2,327 unreached records.]
