...
(updated 2026-09-18): of 3,659, 1,033 have been assessed (516 include / 517
...
2,626 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,033, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-18. Full-text screening is ongoing, not complete -- 2,626 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 517 total, PROVISIONAL):
    E01 wrong topic (n = 150)
...
Included
  Studies included in systematic review (n = 516, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,626 unreached records.]
  Studies included in full extraction so far (n = 516)
    [03_extraction/extracted_data/extraction_database.csv, S001-S518 (S227
