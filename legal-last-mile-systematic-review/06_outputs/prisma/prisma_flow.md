...
(updated 2026-09-22): of 3,659, 1,291 have been assessed (656 include / 635
...
2,368 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,368 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 1,291, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-22. Full-text screening is ongoing, not complete -- 2,368 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 635 total, PROVISIONAL):
...
Included
  Studies included in systematic review (n = 656, PROVISIONAL AND GROWING)
    ...
    still ongoing across the remaining 2,368 unreached records.]
