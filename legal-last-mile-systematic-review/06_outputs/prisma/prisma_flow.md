...
(updated 2026-09-18): of 3,659, 1,052 have been assessed (524 include / 528
...
2,607 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,052, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-19. Full-text screening is ongoing, not complete -- 2,607 of
...
Included
  Studies included in systematic review (n = 524, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,607 unreached records.]
  Studies included in full extraction so far (n = 524)
    [03_extraction/extracted_data/extraction_database.csv, S001-S526 (S227
