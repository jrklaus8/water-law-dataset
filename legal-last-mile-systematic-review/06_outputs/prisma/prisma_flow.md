...
(updated 2026-09-22): of 3,659, 1,322 have been assessed (671 include / 651
...
2,337 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,337 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 1,322, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-22. Full-text screening is ongoing, not complete -- 2,337 of
...
Included
  Studies included in systematic review (n = 671, PROVISIONAL AND GROWING)
    ...
    still ongoing across the remaining 2,337 unreached records.]
