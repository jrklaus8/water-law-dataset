...
(updated 2026-09-22): of 3,659, 1,228 have been assessed (615 include / 613
...
2,431 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,431 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 1,228, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-22. Full-text screening is ongoing, not complete -- 2,431 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 613 total, PROVISIONAL):
    E01 wrong topic (n = 203)
...
Included
  Studies included in systematic review (n = 615, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-22; full-text screening is
    still ongoing across the remaining 2,431 unreached records.]
  Studies included in full extraction so far (n = 615)
    [03_extraction/extracted_data/extraction_database.csv, S001-S617 (S227
