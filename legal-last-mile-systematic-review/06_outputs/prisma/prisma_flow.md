...
(updated 2026-09-18): of 3,659, 986 have been assessed (493 include / 493
...
2,673 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 986, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-18. Full-text screening is ongoing, not complete -- 2,673 of
...
Included
  Studies included in systematic review (n = 493, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,673 unreached records.]
  Studies included in full extraction so far (n = 493)
    [03_extraction/extracted_data/extraction_database.csv, S001-S495 (S227
