...
(updated 2026-09-12): of 3,659, 131 have been assessed (64 include / 67
...
via researcher chat upload — the remaining 3,528 are simply not yet
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    ...
    continues.]
  Reports assessed for eligibility (n = 131, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-12. Full-text screening is ongoing, not complete -- 3,528 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 67 total, PROVISIONAL):
    E01 wrong topic (n = 7)
    E02 wrong population (n = 26)
    E03 wrong exposure (n = 0)
    E04 wrong outcome (n = 13)
...
Included
  Studies included in systematic review (n = 64, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-12; full-text screening is
    still ongoing across the remaining 3,528 unreached records.]
  Studies included in full extraction so far (n = 62)
    [03_extraction/extracted_data/extraction_database.csv, S001-S062.
    Only 2 of the 64 full-text includes remain unextracted, flagged as
