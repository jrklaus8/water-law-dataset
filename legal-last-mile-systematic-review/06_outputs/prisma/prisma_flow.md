...
(updated 2026-09-21): of 3,659, 1,083 have been assessed (536 include / 547
...
2,576 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,083, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-21. Full-text screening is ongoing, not complete -- 2,576 of
...
Included
  Studies included in systematic review (n = 536, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-21; full-text screening is
    still ongoing across the remaining 2,576 unreached records.]
  Studies included in full extraction so far (n = 536)
    [03_extraction/extracted_data/extraction_database.csv, S001-S538 (S227
