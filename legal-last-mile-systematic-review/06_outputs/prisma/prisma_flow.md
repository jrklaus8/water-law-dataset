...
(updated 2026-09-21): of 3,659, 1,090 have been assessed (538 include / 552
...
2,569 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,090, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-21. Full-text screening is ongoing, not complete -- 2,569 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 552 total, PROVISIONAL):
    E01 wrong topic (n = 171)
    E02 wrong population (n = 33)
    E03 wrong exposure (n = 21)
    E04 wrong outcome (n = 49)
    E05 no empirical evidence (n = 56)
...
Included
  Studies included in systematic review (n = 538, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-21; full-text screening is
    still ongoing across the remaining 2,569 unreached records.]
  Studies included in full extraction so far (n = 538)
    [03_extraction/extracted_data/extraction_database.csv, S001-S540 (S227
