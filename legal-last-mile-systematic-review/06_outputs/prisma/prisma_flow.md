...
(updated 2026-09-15): of 3,659, 199 have been assessed (94 include / 105
...
via researcher chat upload — the remaining 3,460 are simply not yet
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 3,460 are all retrievable -- it means
    ...
    continues.]
  Reports assessed for eligibility (n = 199, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-15. Full-text screening is ongoing, not complete -- 3,460 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 105 total, PROVISIONAL):
    E01 wrong topic (n = 23)
    E02 wrong population (n = 29)
    E03 wrong exposure (n = 2)
    E04 wrong outcome (n = 19)
    E05 no empirical evidence (n = 15)
    E06 engineering only (n = 9)
    E07 wrong service (n = 5)
    E08 duplicate (n = 2)
...
Included
  Studies included in systematic review (n = 94, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-15; full-text screening is
    still ongoing across the remaining 3,460 unreached records.]
  Studies included in full extraction so far (n = 94)
    [03_extraction/extracted_data/extraction_database.csv, S001-S094.
