...
(updated 2026-09-15): of 3,659, 252 have been assessed (122 include / 130
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    ...
    continues.]
  Reports assessed for eligibility (n = 252, PROVISIONAL AND GROWING)
  ...
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 120 total, PROVISIONAL):
    ...
    E03 wrong exposure (n = 3)
    E04 wrong outcome (n = 23)
    E05 no empirical evidence (n = 17)
    E06 engineering only (n = 11)
    E07 wrong service (n = 6)
    E08 duplicate (n = 2)
...
Included
  ...
  Studies included in full extraction so far (n = 113)
    [03_extraction/extracted_data/extraction_database.csv, S001-S122.
