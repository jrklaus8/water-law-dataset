...
(updated 2026-09-16): of 3,659, 829 have been assessed (397 include / 432
...
2,830 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,830 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 829, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-16. Full-text screening is ongoing, not complete -- 2,830 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 432 total, PROVISIONAL):
...
Included
  Studies included in systematic review (n = 397, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-16; full-text screening is
    still ongoing across the remaining 2,830 unreached records.]
  Studies included in full extraction so far (n = 397)
    [03_extraction/extracted_data/extraction_database.csv, S001-S399 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 15, PROVISIONAL AND GROWING)
    ...
    much smaller, stricter subset than the 144 studies evidence_map.csv
