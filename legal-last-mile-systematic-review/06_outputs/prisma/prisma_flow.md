...
(updated 2026-09-23): of 3,659, 1,330 have been assessed (677 include / 653
...
2,329 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports not retrieved (n = 0)
    [Not a claim that the remaining 2,329 are all retrievable -- it means
  ...
  Reports assessed for eligibility (n = 1,330, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-23. Full-text screening is ongoing, not complete -- 2,329 of
...
Included
  Studies included in systematic review (n = 677, PROVISIONAL AND GROWING)
    ...
    still ongoing across the remaining 2,329 unreached records.]
