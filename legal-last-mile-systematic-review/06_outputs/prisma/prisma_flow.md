...
(updated 2026-09-22): of 3,659, 1,167 have been assessed (579 include / 588
...
2,492 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 1,167, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-22. Full-text screening is ongoing, not complete -- 2,492 of
...
Included
  Studies included in systematic review (n = 579, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-22; full-text screening is
    still ongoing across the remaining 2,492 unreached records.]
  Studies included in full extraction so far (n = 579)
    [03_extraction/extracted_data/extraction_database.csv, S001-S581 (S227
