...
(updated 2026-09-18): of 3,659, 940 have been assessed (475 include / 465
...
2,719 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 940, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-18. Full-text screening is ongoing, not complete -- 2,719 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 465 total, PROVISIONAL):
    E01 wrong topic (n = 103)
    E02 wrong population (n = 33)
    E03 wrong exposure (n = 20)
    E04 wrong outcome (n = 46)
    E05 no empirical evidence (n = 49)
    E06 engineering only (n = 38)
...
Included
  Studies included in systematic review (n = 475, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,719 unreached records.]
  Studies included in full extraction so far (n = 475)
    [03_extraction/extracted_data/extraction_database.csv, S001-S477 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 22, PROVISIONAL AND GROWING)
    ...
    in the US) from researcher chat uploads. These are the studies with a
    ...
    181 studies evidence_map.csv flags
