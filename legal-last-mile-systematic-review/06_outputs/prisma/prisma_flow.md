...
(updated 2026-09-18): of 3,659, 997 have been assessed (501 include / 496
...
2,662 are simply not yet reached, not confirmed unretrievable. This is
...
Screening  [reviewer_1 (AI) first pass only -- see caveat above]
  ...
  Reports assessed for eligibility (n = 997, PROVISIONAL AND GROWING)
    [02_screening/full_text/full_text_screening_database.csv, updated
    2026-09-18. Full-text screening is ongoing, not complete -- 2,662 of
    3,659 records have not yet been reached.]
  Reports excluded at full text, by reason (E01-E12, see INCLUSION_EXCLUSION.md; n = 496 total, PROVISIONAL):
    E01 wrong topic (n = 130)
...
Included
  Studies included in systematic review (n = 501, PROVISIONAL AND GROWING)
    [Full-text include count as of 2026-09-18; full-text screening is
    still ongoing across the remaining 2,662 unreached records.]
  Studies included in full extraction so far (n = 501)
    [03_extraction/extracted_data/extraction_database.csv, S001-S503 (S227
  ...
  Studies included in quantitative evidence synthesis (n = 25, PROVISIONAL AND GROWING)
    ...
    192 studies evidence_map.csv flags
