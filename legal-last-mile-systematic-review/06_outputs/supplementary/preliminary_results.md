...
- **2026-09-12: Phase 6 (full-text screening) went live and is ongoing.**
  ...
  **381 of 3,659 records decided (186 include / 195 exclude)** — see
...
- **2026-09-15: Phase 8 (full extraction) is fully caught up with Phase
  ...
  **all 140 current full-text includes (S001–S186) are now fully
  extracted** into `extraction_database.csv` against `CODEBOOK.md`'s
  complete 92-field schema. Five of the 186 are themselves secondary
...
- **2026-09-15: Phase 10 (evidence classification) has been run against
  all 186 extracted studies.** `build_evidence_map.py` derived what can
  ...
  per study. **70 of the 186 extracted studies have a genuine,
  study-generated, calculable effect estimate and are judged eligible for
  quantitative synthesis; 167 of 186 are qualitative-synthesis eligible.**
...
- Full-text screening itself is far from complete: 381 of the 3,659
  Phase-5 includes have been assessed; 3,278 records have not yet been
  reached, not confirmed unretrievable, since retrieval depends entirely
  on the researcher supplying full-text PDFs.
- Extraction (Phase 8) is caught up with screening completely — all 186
  current full-text includes are extracted, no outstanding gap.
- **No risk-of-bias rating has been performed on any of the 186 extracted
