...
- **2026-09-12: Phase 6 (full-text screening) went live and is ongoing.**
  ...
  **719 of 3,659 records decided (317 include / 402 exclude)** — see
...
- **2026-09-15: Phase 8 (full extraction) is fully caught up with Phase
  ...
  **all 317 current full-text includes (S001–S317) are now fully
  extracted** into `extraction_database.csv` against `CODEBOOK.md`'s
  complete 92-field schema. Five of the 317 are themselves secondary
...
- **2026-09-15: Phase 10 (evidence classification) has been run against
  all 317 extracted studies.** `build_evidence_map.py` derived what can
  ...
  per study. **122 of the 317 extracted studies have a genuine,
  study-generated, calculable effect estimate and are judged eligible for
  quantitative synthesis; 271 of 317 are qualitative-synthesis eligible.**
...
- Full-text screening itself is far from complete: 719 of the 3,659
  Phase-5 includes have been assessed; 2,940 records have not yet been
  reached, not confirmed unretrievable, since retrieval depends entirely
  on the researcher supplying full-text PDFs.
- Extraction (Phase 8) is caught up with screening completely — all 317
  current full-text includes are extracted, no outstanding gap.
- **No risk-of-bias rating has been performed on any of the 317 extracted
