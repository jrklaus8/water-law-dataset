...
- **2026-09-15: Phase 10 (evidence classification) has been run against
  all 196 extracted studies.** `build_evidence_map.py` derived what can
  ...
  per study. **75 of the 196 extracted studies have a genuine,
  study-generated, calculable effect estimate and are judged eligible for
  quantitative synthesis; 175 of 196 are qualitative-synthesis eligible.**
