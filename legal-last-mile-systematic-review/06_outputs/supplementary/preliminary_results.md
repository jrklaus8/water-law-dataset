...
- **2026-09-12: Phase 6 (full-text screening) went live and is ongoing.**
  ...
  **994 of 3,659 records decided (500 include / 494 exclude)** — see
...
- Full-text screening itself is far from complete: 994 of the 3,659
  Phase-5 includes have been assessed; 2,665 records have not yet been
  reached, not confirmed unretrievable, since retrieval depends entirely
  on the researcher supplying full-text PDFs.
- Extraction (Phase 8) is caught up with screening completely — all 500
  current full-text includes are extracted, no outstanding gap.
- **No risk-of-bias rating has been performed on the great majority of the
  500 extracted studies** (a first 12-study partial pilot batch was
