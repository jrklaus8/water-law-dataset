...
- **2026-09-12: Phase 6 (full-text screening) went live and is ongoing.**
  ...
  **506 of 3,659 records decided (249 include / 257 exclude)** — see
...
- **2026-09-15: Phase 8 (full extraction) is fully caught up with Phase
  ...
  **all 249 current full-text includes (S001–S249) are now fully
  extracted** into `extraction_database.csv` against `CODEBOOK.md`'s
  complete 92-field schema. Five of the 249 are themselves secondary
...
- **2026-09-15: Phase 10 (evidence classification) has been run against
  all 249 extracted studies.** `build_evidence_map.py` derived what can
  ...
  per study. **96 of the 249 extracted studies have a genuine,
  study-generated, calculable effect estimate and are judged eligible for
  quantitative synthesis; 218 of 249 are qualitative-synthesis eligible.**
...
- Full-text screening itself is far from complete: 506 of the 3,659
  Phase-5 includes have been assessed; 3,153 records have not yet been
  reached, not confirmed unretrievable, since retrieval depends entirely
  on the researcher supplying full-text PDFs.
- Extraction (Phase 8) is caught up with screening completely — all 249
  current full-text includes are extracted, no outstanding gap.
- **No risk-of-bias rating has been performed on any of the 249 extracted
