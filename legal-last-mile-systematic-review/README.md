...
live and ongoing — 1,297 of 3,659 records assessed so far. Full extraction
...
holds all 3,659 title/abstract includes; **1,297 have been assessed so far
(659 include / 638 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,362 await the researcher
