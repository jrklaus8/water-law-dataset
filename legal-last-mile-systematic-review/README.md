...
live and ongoing — 1,085 of 3,659 records assessed so far. Full extraction
...
holds all 3,659 title/abstract includes; **1,085 have been assessed so far
(536 include / 549 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,574 await the researcher
