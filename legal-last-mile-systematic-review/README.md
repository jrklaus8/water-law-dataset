...
live and ongoing — 169 of 3,659 records assessed so far. Full extraction
(Phase 8) is essentially caught up with screening — 80 of 82 current
includes fully extracted. Evidence classification (Phase 10) is populated
for all 80. Risk-of-bias rating (Phase 9) and quantitative-feasibility
...
holds all 3,659 title/abstract includes; **169 have been assessed so far
(82 include / 87 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 3,490 await the researcher
...
holds **80 fully-extracted studies (S001–S080)** of the 82 current
...
**Phase 9 (risk of bias) is deliberately not yet applied** to any of the 80
extracted studies — see §6 above for why that is a disclosed limitation, not
an oversight.

**Phase 10 (evidence classification) is populated for all 80 extracted
studies** — [`05_analysis/descriptive/evidence_map.csv`](05_analysis/descriptive/evidence_map.csv),
32 of which are currently judged eligible for quantitative synthesis, all 80
