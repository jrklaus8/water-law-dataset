...
live and ongoing — 151 of 3,659 records assessed so far. Full extraction
(Phase 8) is essentially caught up with screening — 73 of 75 current
includes fully extracted. Evidence classification (Phase 10) is populated
for all 73. Risk-of-bias rating (Phase 9) and quantitative-feasibility
...
holds all 3,659 title/abstract includes; **151 have been assessed so far
(75 include / 76 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 3,508 await the researcher
...
holds **73 fully-extracted studies (S001–S073)** of the 75 current
...
**Phase 10 (evidence classification) is populated for all 73 extracted
