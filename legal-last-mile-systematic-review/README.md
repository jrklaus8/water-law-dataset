...
live and ongoing — 1,122 of 3,659 records assessed so far. Full extraction
...
holds all 3,659 title/abstract includes; **1,122 have been assessed so far
(558 include / 564 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,537 await the researcher
