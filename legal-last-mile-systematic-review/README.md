...
live and ongoing — 1,237 of 3,659 records assessed so far. Full extraction
(Phase 8) is fully caught up with screening — all 620 current
includes extracted, no outstanding gap. Evidence classification (Phase 10) is populated
for all 620. Risk-of-bias rating (Phase 9) has a first 12-study partial
...
holds all 3,659 title/abstract includes; **1,237 have been assessed so far
(620 include / 617 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,422 await the researcher
