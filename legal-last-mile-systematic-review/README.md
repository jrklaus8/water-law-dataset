...
live and ongoing — 994 of 3,659 records assessed so far. Full extraction
(Phase 8) is fully caught up with screening — all 500 current
includes extracted, no outstanding gap. Evidence classification (Phase 10) is populated
for all 500. Risk-of-bias rating (Phase 9) has a first 12-study partial
...
holds all 3,659 title/abstract includes; **994 have been assessed so far
(500 include / 494 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,665 await the researcher
