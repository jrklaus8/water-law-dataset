...
live and ongoing — 831 of 3,659 records assessed so far. Full extraction
(Phase 8) is fully caught up with screening — all 398 current
includes extracted, no outstanding gap. Evidence classification (Phase 10) is populated
for all 398. Risk-of-bias rating (Phase 9) has a first 12-study partial
...
holds all 3,659 title/abstract includes; **831 have been assessed so far
(398 include / 433 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,828 await the researcher
...
holds **all 398 fully-extracted studies (S001–S400, with S227 and S399 documented post-hoc-duplicate gaps)**, matching the 398 current
...
AMSTAR 2 rating of Critically Low; the rest of the 398**
extracted studies remain unappraised — see §6 above for why that is a disclosed limitation, not
an oversight.

**Phase 10 (evidence classification) is populated for all 398 extracted
studies** — [`05_analysis/descriptive/evidence_map.csv`](05_analysis/descriptive/evidence_map.csv),
145 of which are currently judged eligible for quantitative synthesis, 335
