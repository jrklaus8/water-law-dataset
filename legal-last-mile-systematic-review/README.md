...
live and ongoing — 944 of 3,659 records assessed so far. Full extraction
(Phase 8) is fully caught up with screening — all 477 current
includes extracted, no outstanding gap. Evidence classification (Phase 10) is populated
for all 477. Risk-of-bias rating (Phase 9) has a first 12-study partial
...
holds all 3,659 title/abstract includes; **944 have been assessed so far
(477 include / 467 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 2,715 await the researcher
...
holds **all 477 fully-extracted studies (S001–S479, with S227 and S399 documented post-hoc-duplicate gaps)**, matching the 477 current
...
AMSTAR 2 rating of Critically Low; the rest of the 477**
extracted studies remain unappraised — see §6 above for why that is a disclosed limitation, not
an oversight.

**Phase 10 (evidence classification) is populated for all 477 extracted
studies** — [`05_analysis/descriptive/evidence_map.csv`](05_analysis/descriptive/evidence_map.csv),
182 of which are currently judged eligible for quantitative synthesis, 394
