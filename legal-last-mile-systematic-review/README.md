...
live and ongoing — 161 of 3,659 records assessed so far. Full extraction
(Phase 8) is essentially caught up with screening — 77 of 79 current
includes fully extracted. Evidence classification (Phase 10) is populated
for all 77. Risk-of-bias rating (Phase 9) and quantitative-feasibility
...
holds all 3,659 title/abstract includes; **161 have been assessed so far
(79 include / 82 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 3,498 await the researcher
...
holds **77 fully-extracted studies (S001–S077)** of the 79 current
...
**Phase 9 (risk of bias) is deliberately not yet applied** to any of the 77
extracted studies — see §6 above for why that is a disclosed limitation, not
an oversight.

**Phase 10 (evidence classification) is populated for all 77 extracted
studies** — [`05_analysis/descriptive/evidence_map.csv`](05_analysis/descriptive/evidence_map.csv),
31 of which are currently judged eligible for quantitative synthesis, all 77
