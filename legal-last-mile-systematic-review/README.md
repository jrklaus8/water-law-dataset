...
live and ongoing — 156 of 3,659 records assessed so far. Full extraction
(Phase 8) is essentially caught up with screening — 75 of 77 current
includes fully extracted. Evidence classification (Phase 10) is populated
for all 75. Risk-of-bias rating (Phase 9) and quantitative-feasibility
...
holds all 3,659 title/abstract includes; **156 have been assessed so far
(77 include / 79 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 3,503 await the researcher
...
holds **75 fully-extracted studies (S001–S075)** of the 77 current
...
**Phase 10 (evidence classification) is populated for all 75 extracted
