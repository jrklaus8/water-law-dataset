...
live and ongoing — 357 of 3,659 records assessed so far. Full extraction
(Phase 8) is fully caught up with screening — all 169 current
includes extracted, no outstanding gap. Evidence classification (Phase 10) is populated
for all 169. Risk-of-bias rating (Phase 9) and quantitative-feasibility
...
holds all 3,659 title/abstract includes; **357 have been assessed so far
(169 include / 188 exclude)**, with exclusions broken down by E01–E12 reason in
`PRISMA_WORKFLOW.md` Phase 6. The remaining 3,302 await the researcher
...
holds **all 169 fully-extracted studies (S001–S169)**, matching the 169 current
full-text includes with no outstanding gap.

**Phase 9 (risk of bias) is deliberately not yet applied** to any of the 169
extracted studies — see §6 above for why that is a disclosed limitation, not
an oversight.

**Phase 10 (evidence classification) is populated for all 169 extracted
